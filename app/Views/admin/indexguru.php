                ...
                <div class="card">
                    <div class="card-header">
                        <a href="" class="btn btn-primary btn-sm float-right" data-target="#addModal"
                            data-toggle="modal">Tambah Guru</a>
...
<!-- MODAL SIMPAN -->
<form action="/GuruController/save" method="post" onsubmit="return validatePasswords()">
    <div class="modal" tabindex="-1" id="addModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Buat Guru</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <label for="name" class="form-label ml-3">Nama Guru</label>
...
<!-- MODAL EDIT -->
<form action="/GuruController/update" method="post">
...
<!-- MODAL HAPUS -->
<form action="/GuruController/delete" method="post">
...
<form action="/GuruController/changePassword" method="post" onsubmit="return validateChangePasswords()">
    <div class="modal" tabindex="-1" id="changeModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ganti Password Guru</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
